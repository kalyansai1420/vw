...
function Home() {
    return (
        <div className="home">
                    ...
                    <Media>
                        {({ breakpoints, currentBreakpoint }) =>
                            breakpoints[currentBreakpoint] > breakpoints.desktop ? (
                                ...
                                <PhoneIcon fontSize="medium"></PhoneIcon>
                            )
                        }
                    </Media>
            ...
            <svg  className='logohome' width="75" height="75" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
